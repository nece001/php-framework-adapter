 ...
 * @method self whereOr($field, $op = null, $condition = null)
 * @method self whereXor($field, $op = null, $condition = null)
 * @method self whereIn($field, $condition = null)
 * @method self whereNotIn($field, $condition = null)
 * @method self whereBetween($field, $condition = null)
 * @method self whereNotBetween($field, $condition = null)
 * @method self whereLike($field, $condition = null)
 * @method self whereNotLike($field, $condition = null)
 * @method self whereNull($field)
 * @method self whereNotNull($field)
 * @method self whereExists($sql)
 * @method self whereNotExists($sql)
 * @method self whereExp($field, $exp = null)
 * @method self whereColumn($field1, $op = null, $field2)
